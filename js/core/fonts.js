...
export const FONT_REGISTRY = [
  ...
  { key: 'arvo',               label: 'Arvo',                  stack: '"Arvo", Georgia, serif',                         group: 'named' },
  ...
  { key: 'cormorant-garamond', label: 'Cormorant Garamond',    stack: '"Cormorant Garamond", Georgia, serif',           group: 'named' },
  { key: 'crimson-pro',        label: 'Crimson Pro',           stack: '"Crimson Pro", Georgia, serif',                  group: 'named' },
  { key: 'domine',             label: 'Domine',                stack: '"Domine", Georgia, serif',                       group: 'named' },
  ...
  { key: 'fira-code',          label: 'Fira Code',             stack: '"Fira Code", monospace',                         group: 'named' },
  { key: 'gentium-plus',       label: 'Gentium Plus',          stack: '"Gentium Plus", Georgia, serif',                 group: 'named' },
  { key: 'ibm-plex-mono',      label: 'IBM Plex Mono',         stack: '"IBM Plex Mono", monospace',                    group: 'named' },
  ...
  { key: 'playfair-display',   label: 'Playfair Display',      stack: '"Playfair Display", Georgia, serif',             group: 'named' },
  { key: 'pt-serif',           label: 'PT Serif',              stack: '"PT Serif", Georgia, serif',                     group: 'named' },
  { key: 'roboto-mono',        label: 'Roboto Mono',           stack: '"Roboto Mono", monospace',                       group: 'named' },
  ...
  { key: 'space-mono',         label: 'Space Mono',            stack: '"Space Mono", monospace',                        group: 'named' },
  { key: 'spectral',           label: 'Spectral',              stack: '"Spectral", Georgia, serif',                     group: 'named' },
  { key: 'ubuntu-mono',        label: 'Ubuntu Mono',           stack: '"Ubuntu Mono", monospace',                       group: 'named' },
