...
function readTabHTML(p) {
  return [
    ...
    row(t('lbl.penButtonShortcuts'), seg('ss-penbarrel', 'data-penbarrel', [['true', t('opt.on')],['false', t('opt.off')]], String(p.penBarrel))),
...
function wireReadTab(prefs, liveApply) {
  ...
  const SEGS = [
    ...
    { id: 'ss-penbarrel', attr: 'data-penbarrel', pref: 'penBarrel', repag: false, xform: v => v === 'true' },
  ];
